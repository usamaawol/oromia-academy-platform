...
import { n as getResponse, r as requestHandler } from "./request-response-B5fXtxnG.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BiS7CeKa.mjs");
